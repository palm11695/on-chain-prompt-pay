...
include "./components/kbank_account_regex.circom";
// include "./components/twitter_reset_regex.circom";

template KBankVerifier(max_header_bytes, max_body_bytes, n, k, pack_size) {
...
// component main { public [ address ] } = KBankVerifier(1024, 1536, 121, 17, 31);
component main { public [ address ] } = KBankVerifier(640, 896, 121, 17, 31);
